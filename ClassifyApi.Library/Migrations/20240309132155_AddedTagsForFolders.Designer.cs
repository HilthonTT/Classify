...
namespace ClassifyApi.Library.Migrations
{
    ...
    [Migration("20240309132155_AddedTagsForFolders")]
    partial class AddedTagsForFolders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClassifyApi.Library.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ClassifyApi.Library.Models.Folder", b =>
                {
                    b.HasOne("ClassifyApi.Library.Models.Tag", "Tag")
                        .WithMany()
                        .HasForeignKey("TagId");
